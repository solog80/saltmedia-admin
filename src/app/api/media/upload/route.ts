...
// Uploads an image to the mesh storage under a media-library scope (mesh
// optimizes + converts to WebP). The returned public URL is what gets stored
...
export async function POST(request: NextRequest) {
  try {
    ...
    const scope = typeof formData.get("scope") === "string" ? (formData.get("scope") as string) : ""
    ...
    console.error("Media image upload error", e)
